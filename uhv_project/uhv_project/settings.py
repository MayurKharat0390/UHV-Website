...
# ─── Email Configuration ───────────────────────────────────────────────────────
# Uses SMTP. Set the following env variables in your .env / Vercel / Railway dashboard:
#   EMAIL_HOST_USER    → the Gmail address you send FROM (e.g. uhv.cell.pccoe@gmail.com)
#   EMAIL_HOST_PASSWORD → Gmail App Password (NOT your normal Gmail password)
#   CONTACT_RECIPIENT_EMAIL → where contact submissions land (defaults to uhv@pccoepune.org)
...
CONTACT_RECIPIENT_EMAIL = config('CONTACT_RECIPIENT_EMAIL', default='uhv@pccoepune.org')
# ──────────────────────────────────────────────────────────────────────────────
